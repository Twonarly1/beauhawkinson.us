            ...
            <div className="flex items-center justify-center lg:px-16">
                <div className="relative w-full max-w-lg">
                    ...
                    <div className="relative  z-10 space-y-4">
                        <div className="group relative mx-auto mt-12 grid w-fit grid-cols-1 gap-y-4">
                            {starredItems?.map((item: Repo, index: number) => {
                                return (
                                    <a
                                        key={index}
                                        href={item.url}
                                        className="commonBordering duration-600 relative flex items-center p-3 transition fade-up dark:bg-slate-800"
                                    >

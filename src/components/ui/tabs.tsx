        ...
        <PrimitiveTabsList className="text-fg-muted -mb-[2px] flex gap-px">
          {tabs.map(({ value, trigger, disabled }) => (
            <PrimitiveTabTrigger
              ...
              value={value}
              disabled={disabled}
              className="data-[state=active]:text-black data-[state=active]:after:absolute data-[state=active]:after:bottom-0 data-[state=active]:after:left-1/2 data-[state=active]:after:transform data-[state=active]:after:-translate-x-1/2 data-[state=active]:after:w-full data-[state=active]:after:h-[3px] data-[state=active]:after:bg-accent data-[state=active]:after:rounded-tl-[1.5px] data-[state=active]:after:rounded-tr-[1.5px] data-[state=active]:after:rounded-bl-[1.5px] data-[state=active]:after:rounded-br-[1.5px] data-[state=inactive]:hover:text-black data-[state=inactive]:hover:after:absolute data-[state=inactive]:hover:after:bottom-0 data-[state=inactive]:hover:after:left-1/2 data-[state=inactive]:hover:after:transform data-[state=inactive]:hover:after:-translate-x-1/2 data-[state=inactive]:hover:after:w-full data-[state=inactive]:hover:after:h-[3px] data-[state=inactive]:hover:after:bg-neutral-300 data-[state=inactive]:hover:after:rounded-tl-[1.5px] data-[state=inactive]:hover:after:rounded-tr-[1.5px] data-[state=inactive]:hover:after:rounded-bl-[1.5px] data-[state=inactive]:hover:after:rounded-br-[1.5px] relative cursor-pointer py-3 px-4 text-sm disabled:pointer-events-none disabled:opacity-50 md:px-10"
            >
              {trigger}
            </PrimitiveTabTrigger>
          ))}

...
import { Close as ClosePrimitive, Root as RootPrimitive, ToastProps } from "@radix-ui/react-toast"
import classNames from "classnames"
import { AnimatePresence, motion } from "framer-motion"

import { Stack } from "~/core"
import { Confetti, SmileyXEyes, X } from "~/core/icon"
            ...
            {isOpen && (
                <RootPrimitive
                    ...
                    className={classNames(
                        "pointer-events-auto w-full max-w-md overflow-hidden rounded-lg border border-b-4 border-slate-200/10 bg-white shadow-lg dark:bg-primary-dark",
                ...
                >
                    ...
                    >
                        <Stack alignItems="start" direction="horizontal" gap={4}>
                            <div className={classNames("my-auto flex items-center rounded-full")}>
                                {variant === "success" ? (

...
import { Card, Dialog, Toast } from "~/core"
...
export function ContactFormDialog({ children }: Props) {
    ...
    return (
        <>
            <Dialog isOpen={isDialogOpen} onOpenChange={(open) => setIsDialogOpen(open)}>
                ...
                <Dialog.Content isOpen={isDialogOpen}>
                    <Card>
                        ...
                        <Dialog.Description>
                            Please leave your details below and I&apos;ll get back to you as soon as
                            possible. I aim to reply within 12 hours.
                        </Dialog.Description>

                ...
                <div className="mx-auto flex flex-col gap-y-4 overflow-x-scroll p-1 scrollbar-hide">
                    {projects.slice(0, 4).map((project, i: number) => (
                        <Link
                            ...
                            className="group z-10 cursor-default rounded-2xl p-3 hover:bg-gradient-to-r hover:from-gray-50 hover:to-pink-50/80 dark:hover:from-gray-600 dark:hover:to-slate-800"
                        >
